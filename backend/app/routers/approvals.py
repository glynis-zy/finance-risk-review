...
def approve_task(
    ...
    return workflow_service.approve(db, user, task_id)
...
def return_task(
    ...
    return workflow_service.return_to_applicant(db, user, task_id)
...
def reject_task(
    ...
    return workflow_service.reject(db, user, task_id)
